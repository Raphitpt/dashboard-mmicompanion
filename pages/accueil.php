...
echo head("MMI Dashboard - Accueil");
?>
...
<body class="body-login">
    <main class="main-accueil">
        ...
        <div class="title-accueil">
            <h1>BIENVENUE</h1>
            <p>Gérer vos étudiants à la portée d'un clic avec MMI Dashboard ! </br> <span style="font-weight: 600;">Enregistre, organise, réussis !<span></p>
        </div>
